...
<body>
	...
	<div class="evaluate">
		<!-- いいねボタン-->
		<div class="good">
			<img src="/f3/css/images/search/goodBack.png" class="bottom">
			<!-- マンホール画像-->
			<img src="/f3/css/images/search/good.png" class="good-img">
			<!-- ゆび画像-->
			<img src="/f3/css/images/search/goodMessage.png" class="top">
			<!-- メッセージ画像-->
		</div>
		<!-- きもいいねボタン-->
		<div class="grossgood">
			<img src="/f3/css/images/search/grossgoodBack.png" class="bottom">
			<!-- テントウムシ画像-->
			<img src="/f3/css/images/search/good.png" class="good-img">
			<!-- ゆび画像-->
			<img src="/f3/css/images/search/grossgoodMessage.png" class="top">
			<!-- メッセージ画像-->
		</div>
		<!-- こわいいねボタン-->
		<div class="scarygood">
			<img src="/f3/css/images/search/scarygoodBack.png" class="bottom">
			<!-- 顔面画像-->
			<img src="/f3/css/images/search/good.png" class="good-img">
			<!-- ゆび画像-->
			<img src="/f3/css/images/search/scarygoodMessage .png" class="top">
			<!-- メッセージ画像-->
		</div>
	</div>
	<!--常識を破壊するボタン 再読み込み-->
